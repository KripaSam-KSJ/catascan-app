...
const Hello = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-[#6d8c94] px-6 text-center">
      {/* Heading */}
      <h1 className="text-4xl font-extrabold text-gray-800 mb-4">Hello User!!</h1>

      {/* Description */}
      <p className="text-gray-700 text-lg max-w-2xl leading-relaxed">
        <span className="font-semibold text-gray-900">CataScan</span> is a 
        <span className="font-semibold text-gray-900"> User-Friendly WebApp</span> that helps in the early 
        detection of cataract using images taken from your phone.
      </p>
